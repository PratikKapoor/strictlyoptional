+++
title = 'About'
description = 'About Pratik Kapoor and strictlyoptional.com'
layout = 'simple'
+++
...
**Hardware deep-dives** — not reviews, but engineering analysis. I test methodically, measure carefully, and share the data so you can apply the same thinking to your own hardware.

**Engineering methodology** — the process matters as much as the result. I document *how* I approach problems, not just the answers.

**Data-driven decisions** — every claim backed by measurements. No hand-waving, no "it feels faster."
